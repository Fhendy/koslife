<div x-data="{ open: false }" 
     x-show="open" 
     x-on:open-modal.window="if ($event.detail === 'add-income') open = true"
        ...
        <div x-show="open"
            ...
            <form action="{{ route('finance.income.store') }}" method="POST">
                ...
                <div class="bg-white dark:bg-gray-800 px-6 pt-6 pb-4">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center">
                            <i class="fas fa-arrow-up text-xl text-emerald-600 dark:text-emerald-400"></i>
                        </div>
                        <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="description" 
                                   required
                                   placeholder="Contoh: Gaji PKL bulan ini"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <label for="is_debt_income" class="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                        ...
                        <div x-data="{ showDebtor: false }">
                            <div class="flex items-center gap-2">
                                <input type="checkbox" 
                                       x-model="showDebtor"
                                       id="has_debtor_income"
                                       class="rounded border-gray-300 dark:border-gray-600 text-indigo-500 focus:ring-indigo-500">
                                <label for="has_debtor_income" class="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                                    <i class="fas fa-user mr-1"></i> Ada nama pemberi
                                </label>
                            </div>
                            <div x-show="showDebtor" x-cloak class="mt-2">
                                <input type="text" 
                                       name="debtor_name" 
                                       id="debtor_name_income"
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 px-6 py-4 sm:flex sm:flex-row-reverse gap-3">
                    <button type="submit" 
                            class="w-full sm:w-auto px-6 py-2.5 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition-colors font-medium">
