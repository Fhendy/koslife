...
@section('title', 'Tambah Item Belanja')
@section('breadcrumb', 'Tambah Item')
@section('page-title', '🛒 Tambah Item Belanja')
@section('page-description', 'Tambah kebutuhan belanja baru')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="card">
        <form action="{{ route('shopping.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <select name="category" 
                        ...
                        required
                        class="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    <option value="groceries" {{ old('category') == 'groceries' ? 'selected' : '' }}>🛒 Sembako</option>
                    <option value="hygiene" {{ old('category') == 'hygiene' ? 'selected' : '' }}>🧴 Kebersihan</option>
